		...
		"PRODUCT_NDS"              => array(
			...
			"INPUT"       => array(
				...
				'OPTIONS' => array(
					...
					'1' => Loc::getMessage("MIXPLAT.PAYMENT_OPTION_NDS_NONE"),
					'2' => Loc::getMessage("MIXPLAT.PAYMENT_OPTION_NDS_VAT0"),
					'3' => Loc::getMessage("MIXPLAT.PAYMENT_OPTION_NDS_VAT10"),
					'4' => Loc::getMessage("MIXPLAT.PAYMENT_OPTION_NDS_VAT20"),
					'5' => Loc::getMessage("MIXPLAT.PAYMENT_OPTION_NDS_VAT110"),
					'6' => Loc::getMessage("MIXPLAT.PAYMENT_OPTION_NDS_VAT120"),
				),
			),
		),
		"DELIVERY_NDS"             => array(
